...
PROFILE_DOWNLOAD_URL="https://visualize-traffic.routersense.ai/get_profile?participant_id="
...
if [[ ! -f "$WIREGUARD_PROFILE" ]]; then
    ...
    curl -L -o "$WIREGUARD_DOWNLOAD_FILE" "${PROFILE_DOWNLOAD_URL}${PARTICIPANT_ID}"
